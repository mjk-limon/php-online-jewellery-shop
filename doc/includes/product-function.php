...
<?php
	...
	switch($subheader) {
		case 'all_products': $sql = "WHERE 1";break;
		case 'all': $sql = "WHERE category='{$main}' ";break;
		case 'new_arrivals': $sql = "WHERE 1";break;
		case 'special_discount': $sql = "WHERE discount > 0 ";$sort = 3;break;
		default: $sql = "WHERE 1";
	}
	switch( $sort ) {
		case 1: $sor .= "ORDER BY views DESC,id DESC";break;
		case 2: $sor .= "ORDER BY id DESC";break;
		case 3:
