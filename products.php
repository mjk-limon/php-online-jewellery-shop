		...
		<div class="row">
			<div class="col-md-3">
				...
				<div class="agile-box">
					...
					<ul class="agile-list">
						<?php
						$row_min_price	= get_min_price_from_category($main, $sor);

						$row_max_price	= get_max_price_from_category($main, $sor);

						$min_max_price_range = $row_max_price['price'] - $row_min_price['price'];
						$each_sort_min_value = ceil($min_max_price_range / 6) ?: 10;
						?>
						<li>
							<a href="?main=<?= restyle_url($main) ?>&sub=<?= restyle_url($sub) ?>&sort=12&range=<?= $row_min_price['price'] ?>,<?= ($each_sort_min_value * 2); ?>&page=<?= $page; ?>">
								Tk <?= ($row_min_price['price']); ?> - Tk <?= $each_sort_min_value * 2; ?>
							</a>
						</li>
						<li>
