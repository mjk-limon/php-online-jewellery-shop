<?php include "doc/includes/header.php"; ?>
	...
	<div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 1400px; height: 450px; overflow:hidden;">
		...
		<div u="navigator" class="jssorb05" style="bottom: 16px; right: 6px;"><div u="prototype"></div></div>
		<style>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						<ul class="categories">
							<li>
								<a href="search?q=ring"><img src="images/ring.jpg" title="Ring">
									<h2></h2>
									<h3>Ring</h3>
								</a>
							</li>
					...
					<div class=" col-lg-3 col-md-3 col-sm-3 col-xs-12">
						<ul class="categories">
							<li>
								<a href="search?q=earring"><img src="images/earring.jpg" title="Earring">
									<h2></h2>
									<h3>Earring</h3>
								</a>
							</li>
					...
					<div class=" col-lg-3 col-md-3 col-sm-3 col-xs-12">
						<ul class="categories">
							<li>
								<a href="search?q=locket"><img src="images/locket.jpg" title="Locket">
									<h2></h2>
									<h3>Locket</h3>
								</a>
							</li>
					...
					<div class=" col-lg-3 col-md-3 col-sm-3 col-xs-12">
						<ul class="categories">
							<li>
								<a href="search?q=nosepin"><img src="images/nosepin.jpg" title="Nosepin">
									<h2></h2>
									<h3>Nosepin</h3>
								</a>
							</li>
				...
				<div class="row mt-3">
						<div class=" col-lg-3 col-md-3 col-sm-3 col-xs-12">
							<ul class="categories">
								<li>
									<a href="search?q=bracelet"><img src="images/bracelet.jpg" title="Bracelet">
										<h2></h2>
										<h3>Bracelet</h3>
									</a>
								</li>
						...
						<div class=" col-lg-3 col-md-3 col-sm-3 col-xs-12">
							<ul class="categories">
								<li>
									<a href="search?q=necklace"><img src="images/necklace.jpg" title="Necklace">
										<h2></h2>
										<h3>Necklace</h3>
									</a>
								</li>
						...
						<div class=" col-lg-3 col-md-3 col-sm-3 col-xs-12">
								<ul class="categories">
										<li>
												<a href="search?q=bangle"><img src="images/bangle.jpg" title="Bangle">
													<h2></h2>
													<h3>Bangle</h3>
												</a>
										</li>
						...
						<div class=" col-lg-3 col-md-3 col-sm-3 col-xs-12">
								<ul class="categories">
										<li>
												<a href="search?q=pendant+set"><img src="images/pset.jpg" title="pendant set">
														<h2></h2>
														<h3>pendant set</h3>
												</a>
										</li>
