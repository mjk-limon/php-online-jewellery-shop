...
<?php
	...
	$product_name = $row_details['name']; $page_name = 'details-page';
	$pr_price = ($row_details['others'] == 2) ? $caretRate * $row_details['price'] : $row_details['price'];
	$pr_discount_tk= $pr_price*($row_details['discount']/100); $price_after_discount=$pr_price-$pr_discount_tk;	
?>
...
<div class="container">
	...
	<?php } else {	?>
			...
			<div class="col-md-4 single-top-left">	
				<div class="flexslider">
					<ul class="slides">
						...
						?>
							<li data-thumb="proimg/<?= $row_details['id']; ?>/<?= $ava_colors[0].$j; ?>.jpg"  >
								<div class="thumb-image detail_images" id="slides"> <img src="proimg/<?= $row_details['id']; ?>/<?= $ava_colors[0].$j; ?>.jpg"  data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
						<?php } ?>
				...
				<div class="row">
					...
					<script>
						...
						$('.prsize-btn').click(function() {
							...
							$('.prsize-btn').each(function(){$(this).css('background','#fff');});
							...
							<div class="col-md-12">
								<div class="call-box">
									...
									<div class="call-number">
										...
										<p class="cn-number">01911391544</p>
									</div>
									<div class="clearfix"></div>
								</div>
							</div>
		...
		<div class="row details-page-box details-page-bottom">
			<div class="col-md-12 p-0"><h4 class="discription-review-title">Product Full Description</h4></div>
			<div class="col-md-12">
		...
		<div class="row details-page-box">
			<div class="col-md-12 text-center"><h1 class="h1_und">Related Products</h1></div>
		<?php
			...
			$ava_color= $row_trending['colors']; $ava_colors= explode(',', $ava_color);
		?>
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
				<ul class="categories product-tab_l">
					<li>
						<a class="pr-info" href="details.php?prid=<?= $row_trending['id']; ?>">
							<img src="proimg/<?= $row_trending['id']; ?>/<?= $ava_colors[0]; ?>1.jpg" title="Ring">
...
<script>
	$(document).ready(function(){
		...
		$('.add-to-cart').click(function(){
			...
			$.post("ajax.php", {
				prid: <?= $row_details['id']; ?>, qty: item_qty,
				size: pr_size, color: pr_color,
				add_to_cart: 1
			}, function(data,status){
	...
	function keyUpQty(value) {
		if(value <= item_left)
			{item_qty = value; value = value.toString(); $('#item_alert').html('');}
		else
			{$('#item_alert').html('* Low Stock'); $('.item_qty_input').val(item_left);}
		$('.item_qty').css({"width" : 30+(12*(value.length-1)),});
	}
</script>	
