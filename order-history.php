...
<style>
	...
	table.orderHistory-table td img {
		width: 40px;
		vertical-align: top;
		margin-right: 5px
	}
										...
										<div class="col-md-12">
											...
											<table class="table orderHistory-table" style="border: 1px solid #ddd;">
												...
												?>
													<tr>
														<td>
															<img src="proimg/<?php echo $row_details['id'] ?>/1.jpg" alt="Product Image" />
															<?php echo $row_details['name'] ?>
														</td>
														<td> <?php echo $o_products_size[$i] ?> </td>
														<td> <?php echo $o_products_qty[$i] ?> </td>
														<td> <a href="<?php echo $base; ?>details.php?prid=<?php echo $o_products_id[$i] ?>" target="blank"> Details </a> </td>
													</tr>
												<?php } ?>
											</table>
										</div>
