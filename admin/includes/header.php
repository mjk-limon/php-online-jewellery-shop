<?php
	...
	if(isset($_GET['logout'])){setcookie('user',null,time()-3600,"/");header('Location: login.php?emsg='.urlencode("Successfully logged out !"));}
...
<body class="dashboard-page">
	<nav class="main-menu">
		<ul>
			...
			<li>
				<a href="update-site-settings.php?ref=caret">
					<i class="fa fa-diamond nav_icon"></i>
					<span class="nav-text">Caret Price</span>
				</a>
			</li>
			<li>
	...
	<section class="wrapper scrollable">
		...
		<section class="title-bar">
			<div class="logo"><h1><a href="index.php"><img src="../images/logo.png" alt="" /></a></h1></div>
						...
						<ul class="nofitications-dropdown">
							...
							?>
								...
								<ul class="dropdown-menu anti-dropdown-menu w3l-msg">
									<li><div class="notification_header"><h3>You have <?= $unread_message_count; ?> new messages</h3></div></li>
								<?php
								...
								?>
									<li><div class="notification_bottom"><a href="site-data.php?dt=msg">See all messages</a></div></li>
								</ul>
							</li>
							<li class="dropdown head-dpdn">
							<?php
							...
							?>
								...
								<ul class="dropdown-menu anti-dropdown-menu agile-notification">
									<li><div class="notification_header"><h3>You have <?= $unread_order_count; ?> new orders</h3></div></li>
								<?php
								...
								?>
									<li><div class="notification_bottom"><a href="site-data.php?dt=odr">See all orders</a></div></li>
								</ul>
							</li>
							<div class="clearfix"> </div>
						</ul>
